...
| AI reference files | `backend/resources/ai_reference/` | `resources/ai_reference/` |
| JSON Schemas | `backend/resources/schemas/` | `resources/schemas/` |
| Frontend SPA | `frontend/dist/` | `frontend_dist/` |
| Beancount VERSION file | site-packages | `beancount/` |
| Finzytrack VERSION file | `VERSION` | bundle root |
